...
LOGO = """<svg viewBox="0 0 40 40" aria-hidden="true">
        ...
        <circle cx="8" cy="30" r="3.6" fill="#E0A33C"/><circle cx="16" cy="30" r="3.6" fill="#D4594A"/>
        <circle cx="24" cy="30" r="3.6" fill="#9C4278"/><circle cx="32" cy="30" r="3.6" fill="#2C4356"/>
      </svg>"""
...
FAVICON = ("data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40'%3E%3Ccircle cx='20' cy='7' r='4.5' fill='%232A2333'/%3E"
           ...
           "%3Ccircle cx='8' cy='30' r='3.6' fill='%23E0A33C'/%3E%3Ccircle cx='16' cy='30' r='3.6' fill='%23D4594A'/%3E"
           "%3Ccircle cx='24' cy='30' r='3.6' fill='%239C4278'/%3E%3Ccircle cx='32' cy='30' r='3.6' fill='%232C4356'/%3E%3C/svg%3E")
